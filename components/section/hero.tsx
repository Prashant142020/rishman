...
export function Hero() {
  return (
    <section
      ...
      className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-secondary to-background"
    >
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-neutral-600 leading-relaxed text-pretty">
                Dedicated educator and researcher with expertise in cutting-edge academic fields.
                Passionate about inspiring the next generation of scholars and innovators.
              </p>
            </div>
