...
const publications: Publication[] = [
  {
    title: 'The evolving influence of news and social media sentiments on Indian sectoral returns during COVID-19: TVP-VAR extended joint connectedness approach',
  ...
  {
    title: 'Asymmetric impact of social media sentiments and stock market uncertainty on Indian sectoral returns: A quantile-on-quantile approach',
    authors: ['Khan, H. A.', 'Chahal, R. J. K.'],
  ...
  {
    title: 'Political Connections and Corporate Debt Structure: Moderating effect of Government-owned Banks of India',
  ...
  {
    title: 'Central bank digital currency and multidimensional bank stability index: Does monetary policy play a moderating role?',
  ...
  {
    title: 'Do Political Connections Spur Technology Transfer? Evidence from Governance Perspective in India',
  ...
  {
    title: 'Understanding the impact of the coronavirus outbreak on the economic integration of ASEAN countries',
  ...
  {
    title: 'A Firm-level Analysis of the Impact of the Coronavirus Outbreak in ASEAN',
    authors: ['Ahmad, W', 'Chahal, R. J. K.', 'Rais, S'],
  ...
  {
    title: 'COVID-19 Pandemic and firm-level dynamics in the USA, UK, Europe, and Japan',
    authors: ['Ahmad, W.', 'Kutan, Ali M.', 'Chahal, R. J. K.', 'Kattumuri, Ruth'],
  ...
  },
  {
    ...
    authors: ['Ahmad, W.', 'Prakash, R.', 'Uddin, G. S.', 'Chahal, R. J. K.', 'Rahman, M. L.', 'Dutta, A'],
    journal: 'Energy Economics',
    year: 2020,
    doi: 'https://doi.org/10.1016/j.eneco.2020.104871',
  },
  {
    title: 'Political Connections, Investment Inefficiency and the Indian Banking Crisis',
    authors: ['Chahal, R. J. K.', 'Ahmad, W'],
